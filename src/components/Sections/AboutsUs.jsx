                    ...
                    <div className="row" style={{ paddingBottom: "30px" }}>
                        <div className="col-xs-12 col-sm-12 col-md-6 col-lg-6 whiteColor" >
                            <ul>
                                ...
                                <li><p>ERP TECH is at the vanguard of ERP solutions, providing incomparable amenities affiliated to the ERP Logistics & Supply Chain Management requests and business goals of our customers</p></li>
